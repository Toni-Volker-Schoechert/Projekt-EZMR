...
Hier wurde ein einfache IPC-Server erstellt. Dieser wartet auf eingehende Nachrichten von Clients und antwortet darauf mit einer Bestätigung und Zustandsinformation. 
Der Server erstellt hier als erstes mit socket() einen UNIX Socket, welcher mit bind() im System angelegt wird. In der Funktion handle_client() wird dabei der Umgang mit dem jewiligem Client festgelegt. Diese überprüft zuerst die größe der eingehenden Nachricht, ließt diese ein und sendet danach eine Antwort. Daraufhin wird die Server-Client-Verbindung geschlossen. 